...
export function bootstrap() {
  // Ta wersja nie ma nakładki wejściowej: pierwsza rzecz, którą widać, to już
  // treść strony. renderIcons() idzie na początek, bo wstawia kilkadziesiąt SVG
  // i lepiej, żeby zrobiło to przed pierwszym przewinięciem.
  renderIcons();
  initTheme();
  setCurrentYear();
  initMobileMenu();
