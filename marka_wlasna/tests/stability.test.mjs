...
test("100 competing intro skips and Escape presses clean up only once", async () => {
  installDom(`
    <div data-intro hidden>
      <button data-intro-skip>Pomiń</button>
    </div>
  ...
  assert.equal(sessionStorage.getItem("krojnia-intro-seen"), "true");
});
